...
pcoord_1 = np.loadtxt('rmsd.temp')[0][1]
pcoord_2 = np.loadtxt('rmsd.temp')[1][1]
...
restart_file_1 	= 'parent.rst7'
restart_file_2  = 'seg.rst7'
...
# Get system coordinate u_pos
u_pos_1 = mdtraj_load_pos(restart_file_1, param_file)
u_pos_2 = mdtraj_load_pos(restart_file_2, param_file)
...
dimreduce_2 = dimreduce_model.transform(featurization(u_pos_2))#[0])
X_2 = np.concatenate(([pcoord_2], dimreduce_2))
cluster_assignment_2 = stratified_clustering(bin_boundaries, kmeans_models, X_2)

# Get bin assignment
bin_assignment_1 = binning[cluster_assignment_1]
bin_assignment_2 = binning[cluster_assignment_2]

# Save as pcoord_and_bin
np.savetxt('pcoord_and_bin.dat', [[pcoord_1, bin_assignment_1], [pcoord_2, bin_assignment_2]], fmt='%.6f %d')
