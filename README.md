This repository contains an updated haMSM (history augmented Markov state model) pipeline to analyze nonequilibrium steady state WE (weighted ensemble) simulations. 
